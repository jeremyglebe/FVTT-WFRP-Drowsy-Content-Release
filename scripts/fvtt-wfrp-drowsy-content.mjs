...
var gt = class {
	...
	set(e, t, n, r) {
		...
		return e === /* @__PURE__ */ F(r) && (o ? E(n, i) && tt(e, "set", t, n, i) : tt(e, "add", t, n)), s;
	}
	deleteProperty(e, t) {
...
function Et(e, t) {
	let n = {
		...
		has(t) {
			...
			return e || (E(t, i) && N(r, "has", t), N(r, "has", i)), t === i ? n.has(t) : n.has(t) || n.has(i);
		},
		forEach(n, r) {
...
var Jt = class {
	...
	set value(e) {
		...
		e = n ? e : /* @__PURE__ */ F(e), E(e, t) && (this._rawValue = e, this._value = n ? e : Wt(e), this.dep.trigger());
	}
};
function L(e) {
...
function sn(e, n, i = t) {
	...
	let S = b ? Array(e.length).fill(nn) : nn, C = (e) => {
	...
	return u && u(C), m = new Ae(g), m.scheduler = l ? () => l(C, !1) : C, v = (e) => on(e, !1, m), _ = m.onStop = () => {
		let e = rn.get(m);
		if (e) {
			if (f) f(e, 4);
...
function _r(e, t, n = !0, r = !1) {
	...
	if (i) {
		...
		if (e === mr) {
			let e = Ca(n, !1);
			if (e && (e === t || e === w(t) || e === ae(w(t)))) return n;
		}
...
function kr(e) {
	...
	if (D(ir, p), D(ar, m), D(or, g), D(sr, _), D(Qn, y), D($n, b), D(pr, w), D(fr, ne), D(dr, re), D(cr, ee), D(lr, C), D(ur, ie), d(T)) if (T.length) {
		let t = e.exposed ||= {};
		T.forEach((e) => {
	...
	te && e.render === r && (e.render = te), ae != null && (e.inheritAttrs = ae), oe && (e.components = oe), E && (e.directives = E), ie && Gn(e);
}
function Ar(e, t, n = r) {
	d(e) && (e = Rr(e));
	for (let n in e) {
...
var Gr = null, Kr = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${w(t)}Modifiers`] || e[`${T(t)}Modifiers`];
function qr(e, n, ...r) {
...
function ci(e, t, n, r) {
	...
	if ((r || o > 0) && !(o & 16)) {
		...
		li(e, t, i, a) && (l = !0);
		let r;
		for (let a in s) (!t || !u(t, a) && ((r = T(a)) === a || !u(t, r))) && (c ? n && (n[a] !== void 0 || n[r] !== void 0) && (i[a] = di(c, s, a, void 0, e, !0)) : delete i[a]);
...
function li(e, n, r, i) {
	...
	if (n) for (let t in n) {
		if (te(t)) continue;
		let l = n[t], d;
		a && u(a, d = w(t)) ? !o || !o.includes(d) ? r[d] = l : (c ||= {})[d] = l : Xr(e.emitsOptions, t) || (!(t in i) || l !== i[t]) && (i[t] = l, s = !0);
	}
	if (o) {
...
function wi(e, i) {
	...
	let { insert: o, remove: s, patchProp: c, createElement: l, createText: u, createComment: d, setText: f, setElementText: p, parentNode: m, nextSibling: h, setScopeId: g = r, insertStaticContent: _ } = e, v = (e, t, n, r = null, i = null, a = null, o = void 0, s = null, c = !!t.dynamicChildren) => {
		if (e === t) return;
		e && !Gi(e, t) && (r = be(e), O(e, i, a, !0), e = null), t.patchFlag === -2 && (c = !1, t.dynamicChildren = null);
		...
		switch (l) {
			...
			case W:
				...
				break;
			default: d & 1 ? C(e, t, n, r, i, a, o, s, c) : d & 6 ? E(e, t, n, r, i, a, o, s, c) : (d & 64 || d & 128) && l.process(e, t, n, r, i, a, o, s, c, k);
		}
		...
		if (d = e.el = l(e.type, a, m && m.is, m), h & 8 ? p(d, e.children) : h & 16 && w(e.children, d, null, r, i, Ti(e, a), s, u), _ && An(e, null, r, "created"), re(d, e, e.scopeId, s, r), m) {
		...
		if (r && Ei(r, !1), (g = h.onVnodeBeforeUpdate) && ra(g, r, n, e), f && An(n, e, r, "beforeUpdate"), r && Ei(r, !0), (m.innerHTML && h.innerHTML == null || m.textContent && h.textContent == null) && p(l, ""), d ? T(e.dynamicChildren, d, l, r, i, Ti(n, a), o) : s || fe(e, n, l, null, r, i, Ti(n, a), o, !1), u > 0) {
		...
		h && (c = c ? c.concat(h) : h), e == null ? (o(d, n, r), o(f, n, r), w(t.children || [], n, f, i, a, s, c, l)) : p > 0 && p & 64 && m && e.dynamicChildren && e.dynamicChildren.length === m.length ? (T(e.dynamicChildren, m, n, i, a, s, c), (t.key != null || i && t === i.subTree) && Oi(e, t, !0)) : fe(e, t, n, f, i, a, s, c, l);
	}, E = (e, t, n, r, i, a, o, s, c) => {
		t.slotScopeIds = s, e == null ? t.shapeFlag & 512 ? i.ctx.activate(t, n, r, o, c) : D(t, n, r, i, a, o, c) : ce(e, t, c);
	}, D = (e, t, n, r, i, a, o) => {
		let s = e.component = oa(e, r, i);
		if (Zn(e) && (s.ctx.renderer = k), ma(s, !1, o), s.asyncDep) {
		...
		let s = () => {
			if (e.isMounted) {
				...
				let u = t, d;
				Ei(e, !1), t ? (t.el = c.el, de(e, t, o)) : t = c, n && se(n), (d = t.props && t.props.onVnodeBeforeUpdate) && ra(d, s, t, c), Ei(e, !0);
				let f = Zr(e), p = e.subTree;
				e.subTree = f, v(p, f, m(p.el), be(p), e, i, a), t.el = f.el, u === null && ri(e, f.el), r && U(r, i), (d = t.props && t.props.onVnodeUpdated) && U(() => ra(d, s, t, c), i);
			} else {
				let o, { el: s, props: c } = t, { bm: l, m: u, parent: d, root: f, type: p } = e, m = Xn(t);
				if (Ei(e, !1), l && se(l), !m && (o = c && c.onVnodeBeforeMount) && ra(o, d, t), Ei(e, !0), s && we) {
					let t = () => {
						e.subTree = Zr(e), we(s, e.subTree, e, i, null);
					};
		...
		t.component = e;
		let r = e.vnode.props;
		e.vnode = t, e.next = null, ci(e, t.props, r, n), Si(e, t.children, n), We(), wn(e), Ge();
		...
		if (u > f) {
			...
			for (u = m; u <= f; u++) {
				...
				else for (_ = h; _ <= p; _++) if (S[_ - h] === 0 && Gi(n, t[_])) {
					i = _;
					break;
				}
		...
		if (g && (_ = o && o.onVnodeBeforeUnmount) && ra(_, t, e), u & 6) ve(e.component, n, r);
		else {
			if (u & 128) {
				e.suspense.unmount(n, r);
				return;
			}
			h && An(e, null, t, "beforeUnmount"), u & 64 ? e.type.remove(e, t, n, k, r) : l && !l.hasOnce && (a !== W || d > 0 && d & 64) ? ye(l, t, n, !1, !0) : (a === W && d & 384 || !i && u & 16) && ye(c, t, n), r && ge(e);
		}
		let v = m != null && p == null;
		...
		ji(c), ji(l), r && se(r), i.stop(), a && (a.flags |= 8, O(o, e, t, n)), s && U(s, t), U(() => {
			e.isUnmounted = !0;
		}, t);
...
function Ua(e, t, n) {
	if (d(n)) n.forEach((n) => Ua(e, t, n));
		...
		let r = Ka(e, t);
		Ha.test(n) ? e.setProperty(T(r), n.replace(Ha, ""), "important") : e[r] = n;
	}
}
var Wa = [
	"Webkit",
...
var so = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, co = (e, t, n, r, i, s) => {
	let c = i === "svg";
	t === "class" ? Ia(e, r, c) : t === "style" ? Va(e, n, r) : a(t) ? o(t) || eo(e, t, n, r, s) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : lo(e, t, r, c)) ? (Xa(e, t, r), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && Ya(e, t, r, c, s, t !== "value")) : e._isVueCE && (uo(e, t) || e._def.__asyncLoader && (/[A-Z]/.test(t) || !g(r))) ? Xa(e, w(t), r, s, t) : (t === "true-value" ? e._trueValue = r : t === "false-value" && (e._falseValue = r), Ya(e, t, r, c));
};
function lo(e, t, n, r) {
...
function ss(e, t, n = {}, r, i, a) {
	...
	r._s.set(e, y);
	let b = (r._a && r._a.runWithContext || Qo)(() => r._e.run(() => (o = Ee()).run(() => t({ action: v }))));
	for (let t in b) {
		let n = b[t];
...
var us = cs("demo-components", { state: () => ({ cardDemos: ls() }) }), ds = { key: 0 }, fs = { class: "tw:dui-card-body" }, ps = {
	...
	setup(e) {
		...
		return (t, n) => (K(), q("article", { class: O(i.value) }, [t.$slots.media ? (K(), q("figure", ds, [xr(t.$slots, "media")])) : Qi("", !0), J("div", fs, [
	...
	setup(e) {
		...
		return (t, o) => (K(), Ui(gs, {
			...
			default: B(() => [
				J("header", null, [o[5] ||= J("h1", { class: "tw:text-2xl tw:font-semibold" }, "Resolve Multiple Attacks", -1), J("p", ws, " Stage one attack through WFRP’s standard roll dialog, repeat it against " + k(e.defenderName) + ", then post one summary card with native damage actions. ", 1)]),
				L(n).error ? (K(), q("div", Ts, [J("span", null, k(L(n).error), 1)])) : Qi("", !0),
				L(n).summary ? (K(), q("div", Es, [J("span", null, " Posted " + k(L(n).summary.results.length) + " results: " + k(L(n).summary.attackWins) + " attack wins, " + k(L(n).summary.defenseWins) + " defense wins, and " + k(L(n).summary.totalDamage) + " potential damage. Apply individual hits or all remaining damage from the chat card. ", 1)])) : Qi("", !0),
				Y(hs, {
					size: "sm",
					...
					actions: B(() => [J("button", {
						...
						type: "submit"
					}, k(L(n).resolving ? "Staging and resolving…" : "Stage Attack and Resolve"), 9, Rs)]),
					default: B(() => [Y(_s, {
						columns: "two",
						gap: "sm"
					}, {
						default: B(() => [
							...
							J("fieldset", Os, [
								J("legend", ks, k(e.attackerName) + " attacks with", 1),
								o[9] ||= J("label", {
									class: "tw:dui-label",
								...
								V(J("select", {
									...
									key: e.id,
									value: e.id
								}, k(e.label), 9, js))), 128))], 8, As))), 128))], 512), [[vo, L(n).configuration.attackOptionId]])
							]),
							J("fieldset", Ms, [
								J("legend", Ns, k(e.defenderName) + " responds with", 1),
								o[10] ||= J("label", {
									class: "tw:dui-label",
								...
								V(J("select", {
									...
									key: e.id,
									value: e.id
								}, k(e.label), 9, Fs))), 128))], 8, Ps))), 128))], 512), [[vo, L(n).configuration.defenseOptionId]])
							]),
							J("fieldset", Is, [
								o[11] ||= J("legend", { class: "tw:dui-fieldset-legend" }, "Attack dialog starting modifier", -1),
								o[12] ||= J("label", {
									class: "tw:dui-label",
							...
							J("fieldset", Ls, [
								o[13] ||= J("legend", { class: "tw:dui-fieldset-legend" }, "Response starting modifier", -1),
								o[14] ||= J("label", {
									class: "tw:dui-label",
						...
						role: "note"
					}, [J("span", null, " Resolve opens WFRP’s attack dialog once. Its range, difficulty, talent/effect modifiers, ammunition choice, and other selections are staged for every attack. WFRP recomputes the selected response and opposed effects for each result; ordinary roll cards stay hidden. ")], -1)]),
					_: 1
				}, 8, ["title"])
			]),
			_: 1
...
async function lc(e) {
	return foundry.applications.handlebars.renderTemplate(`modules/${Z}/templates/multi-attack/chat-card.hbs`, e);
}
//#endregion
...
function fc(e, t = "attack") {
	let n = Array.from(e.items).filter(vc).map((e) => ({
		group: dc[e.type] ?? "Other",
		id: `${e.type}:${e.id}`,
		kind: e.type,
		label: e.name
	})).sort(yc), r = Object.entries(gc()).map(([e, t]) => ({
		group: "Characteristics",
		id: `characteristic:${e}`,
		kind: "characteristic",
		label: t
	}));
	if (t === "attack") return [...n, ...r];
	let i = _c(), a = n.find((e) => e.kind === "skill" && e.label === i);
	return [
		{
			group: "Responses",
			id: "unopposed",
...
function pc(e, t) {
	if (t === "unopposed") return {
		id: t,
		kind: "unopposed",
		label: "Unopposed"
	};
	let [n, r] = t.split(":");
	if (n === "characteristic" && r && r in gc()) return {
		id: t,
		key: r,
		kind: n,
		label: gc()[r] ?? r
	...
	if (!i || !vc(i)) throw Error(`${e.name} no longer has the selected Test option.`);
	return {
		id: t,
		item: i,
		kind: n,
...
function hc(e) {
	let t = _c();
	return (e.find((e) => e.kind === "skill" && e.label === t) ?? e.find((e) => e.kind === "weapon") ?? e.find((e) => e.kind === "unopposed") ?? e.find((e) => e.id === "characteristic:ws") ?? e[0])?.id ?? "";
}
function gc() {
	return game?.wfrp4e?.config.characteristics ?? uc;
}
function _c() {
	return game?.i18n?.localize("NAME.Dodge") ?? "Dodge";
}
function vc(e) {
...
function bc({ attackerName: e, attackOptionLabel: t, defenderName: n, defenseOptionLabel: r, results: i }) {
	return {
		attackCriticals: xc(i, "attack"),
		attackerName: e,
		attackOptionLabel: t,
		attackWins: i.filter((e) => e.winner === "attacker").length,
		defenseCriticals: xc(i, "defense"),
		defenderName: n,
		defenseOptionLabel: r,
		defenseWins: i.filter((e) => e.winner === "defender").length,
		damageApplicationsAvailable: i.filter((e) => e.canApplyDamage).length,
		results: i,
...
function Sc(e, t, n = !1) {
	let r = t.result.winner;
	if (!r) throw Error(`Opposed Test ${e} has no winner.`);
	let i = Cc(t.attackerTest), a = Cc(t.defenderTest), o = Tc(t.result.damage?.value), s = t.result.hitloc?.value;
	return {
		attack: i,
		...r === "attacker" && o !== void 0 ? { canApplyDamage: !0 } : {},
		defense: a,
		index: e,
		netSL: i.sl - a.sl,
		opposedTestData: foundry.utils.deepClone(t.data),
		...n ? { unopposed: !0 } : {},
		winner: r,
		...o === void 0 ? {} : { damage: o },
		...s ? { hitLocation: s } : {}
...
function Cc(e) {
	...
	return {
		...
		roll: Tc(t.roll) ?? 0,
		sl: Tc(t.SL) ?? 0,
		tables: Object.values(t.tables ?? {}).flatMap(wc),
		target: Tc(t.target) ?? 0
	};
}
function wc(e) {
...
async function Dc(e, t, n) {
	let r = CONFIG.ChatMessage.dataModels.opposed;
	if (!r) throw Error("The WFRP4e opposed Test model is unavailable.");
	let i = new r({ opposedTestData: {
		attackerTestData: e.data,
		...n ? { defenderTestData: n.data } : {},
		opposeResult: foundry.utils.deepClone(Ec)
	} }).opposedTest;
	if (n || i.createUnopposedDefender(t), i.attackerTest.renderRollCard = async () => void 0, i.defenderTest.renderRollCard = async () => void 0, !await i.evaluate() || !i.result.winner) throw Error("WFRP4e could not evaluate an opposed Test.");
	return i;
}
//#endregion
//#region src/module/multi-attack/setup-test.ts
async function Oc({ actor: e, attackerToken: t, modifier: n, option: r, target: i, type: a }) {
	let o = () => Mc({
		actor: e,
		modifier: n,
		option: r,
...
async function kc(e) {
	let t = game?.wfrp4e?.rolls?.TestWFRP;
	if (!t) throw Error("The WFRP4e Test recreation API is unavailable.");
	let n = t.recreate(foundry.utils.deepClone(e.data));
	return await Nc(n), n;
}
async function Ac(e) {
	return Pc(e.actor, e.attackerTest, async () => {
		let t = await Mc(e, !0);
		return await Nc(t), t;
	});
}
async function jc(e, t) {
	await Pc(e, t, async () => {
		let n = Fc(t);
		await Promise.all(e.runScripts?.("targeted", {
			attacker: n,
			test: t
		}) ?? []);
	});
}
async function Mc({ actor: e, attackerToken: t, modifier: n, option: r, target: i, type: a }, o) {
	let s = {
		defending: a === "defense",
		fields: { modifier: n },
		skipDialog: o,
		skipTargets: a === "defense" || !i
	};
	a === "attack" && t && (s.speaker = e.speakerData(t)), a === "attack" && i && (s.targets = [i]);
	let c;
	if (r.kind === "characteristic" && r.key ? c = await e.setupCharacteristic(r.key, s) : r.kind === "skill" && r.item ? c = await e.setupSkill(r.item, s) : r.kind === "trait" && r.item ? c = await e.setupTrait(r.item, s) : r.kind === "weapon" && r.item && (c = await e.setupWeapon(r.item, s)), !c) throw Error(`${e.name} could not prepare ${r.label}.`);
	return c;
}
async function Nc(e) {
	e.renderRollCard = async () => void 0, e.handleOpposed = async () => void 0, await e.roll();
}
async function Pc(e, t, n) {
	let r = e, i = Object.getOwnPropertyDescriptor(r, "attacker"), a = Object.getOwnPropertyDescriptor(r, "isOpposing");
	...
	try {
		...
		Lc(r, "attacker", i), Lc(r, "isOpposing", a);
	}
}
function Fc(e) {
	let t = e.context.chatOptions, n = t && typeof t == "object" && "speaker" in t ? t.speaker : e.context.speaker;
	return {
		img: e.actor.img,
		messageId: "",
		speaker: n,
...
async function Ic(e, t, n) {
	if (e.getActiveTokens()[0] === t) return n();
	let r = e, i = Object.getOwnPropertyDescriptor(r, "getActiveTokens");
	Object.defineProperty(r, "getActiveTokens", {
		configurable: !0,
		value: () => [t]
	});
	try {
...
async function Rc(e) {
	Bc(e);
	let t = pc(e.attacker, e.attackOptionId), n = pc(e.defender, e.defenseOptionId), r = [], i = await Oc({
		actor: e.attacker,
		modifier: e.attackModifier,
		option: t,
		type: "attack",
		...e.attackerToken ? { attackerToken: e.attackerToken } : {},
		...e.target ? { target: e.target } : {}
	});
	for (let t = 1; t <= e.attacks; t += 1) {
		let a = await kc(i);
		await jc(e.defender, a);
		let o = n.kind === "unopposed" ? void 0 : await Ac({
			actor: e.defender,
			attackerTest: a,
			modifier: e.defenseModifier,
			option: n,
			type: "defense"
		}), s = await Dc(a, e.defender, o);
		r.push(Sc(t, s, n.kind === "unopposed"));
	}
	return bc({
...
async function zc(e) {
	let t = Hc(e.attackerToken), n = Hc(e.target);
	return Rc({
		attackModifier: e.attackModifier,
		attacker: Vc(e.attacker, "attacker"),
		...t ? { attackerToken: t } : {},
		attackOptionId: e.attackOptionId,
		attacks: e.attacks,
		defender: Vc(e.defender, "defender"),
...
var Uc = class extends xs {
	...
	getVueProps() {
		let { attacker: e, attackerToken: t, defender: n, target: r } = this.#e, i = fc(e), a = fc(n, "defense");
		if (i.length === 0 || a.length === 0) throw Error("Both Actors need at least one supported Test option.");
		return {
			attackerName: e.name,
			attackOptions: i,
			defenderName: n.name,
...
function Wc(e, t) {
	let n = canvas?.tokens.controlled ?? [], r = Array.from(game?.user?.targets ?? []), i = Kc(e), a = n.length === 1 ? n[0] : void 0, o = Gc(e) ?? Gc(a?.actor);
	if (!o) throw Error("Select one attacker token or pass an attacker Actor.");
	let s = i ?? (a?.actor === o ? a : void 0) ?? qc(o), c = Kc(t) ?? (r.length === 1 ? r[0] : void 0), l = Gc(t) ?? c?.actor;
	if (!l) throw Error("Target one defender token or pass a defender Actor.");
	if (s && c && Jc(s, c) || (!s || !c) && o === l) throw Error("Attacker and defender must be different Actors.");
	return {
		attacker: o,
		defender: l,
		...s ? { attackerToken: s } : {},
...
function Gc(e) {
	if (!(!e || typeof e != "object")) return "actor" in e ? Gc(e.actor) : "setupCharacteristic" in e && "items" in e ? e : void 0;
}
function Kc(e) {
	if (!(!e || typeof e != "object" || !("actor" in e) || !("document" in e))) return e;
}
function qc(e) {
	let t = e.getActiveTokens();
	return t.length === 1 ? t[0] : void 0;
}
function Jc(e, t) {
	if (e === t || e.document === t.document) return !0;
	let n = e.document.parent?.id, r = t.document.parent?.id;
	return e.document.id === t.document.id && (!n || !r || n === r);
}
//#endregion
...
function Zc(e) {
	let t = e;
	return rl(t) ? "hidden" : il(t) ? "automatic" : al(t) ? ol(t) ? "automatic" : "optional" : "hidden";
}
function Qc(e, t) {
	return !!(Q(e)?.rankBonusSL && Zc(t) !== "hidden");
}
function $c(e, t) {
	return !!(Q(e)?.rankBonusSL && Zc(t) === "automatic");
}
function el(e, t) {
	let n = Q(e);
	if (!n || n.rankBonusSL < 1 || Zc(t) === "hidden") return;
...
function sl() {
	return {
		multiAttack: {
			getOptions(e, t = "attack") {
				return fc(e, t);
			},
			async open(e, t) {
				await new Uc(Wc(e, t)).render(!0);
			},
			postSummary: cc,
			resolve: zc
		},
		...
		unit: {
			...
			applyWounds: Xc,
			getState: nl,
			shouldActivateRankBonus: $c,
			shouldShowRankBonus: Qc
		}
	};
}
//#endregion
...
//#endregion
//#region src/module/multi-attack/damage.ts
async function ll({ damageType: e, messageId: t, recreateOpposedTest: n, result: r }) {
	if (!r.canApplyDamage || r.damageApplied || !r.opposedTestData) throw Error(`Damage for attack ${r.index} is not available to apply.`);
	let i = n(r.opposedTestData), a = i.defenderTest.actor;
	if (!a.isOwner) throw Error("You do not have permission to apply damage to the defender.");
	i.attackerTest.context.messageId = t;
	let o = await a.applyDamage(null, {
		damageType: e,
		opposedTest: i
	});
	r.canApplyDamage = !1, r.damageApplied = !0, r.damageApplication = o ?? "<b>Damage applied.</b>";
}
//#endregion
//#region src/module/multi-attack/chat-actions.ts
var ul = "data-multi-attack-action", dl = /* @__PURE__ */ new Set();
function fl() {
	Hooks.on("renderChatMessageHTML", (...e) => {
		let t = e[0], n = e[1];
		!(n instanceof HTMLElement) || !yl(t) || n.addEventListener("click", (e) => {
			pl(t, e);
		});
	});
}
async function pl(e, t) {
	let n = t.target instanceof Element ? t.target.closest(`[${ul}]`) : null;
	if (n && (t.preventDefault(), !dl.has(e.id))) {
		dl.add(e.id), n.setAttribute("disabled", "");
		try {
			let t = n.dataset.multiAttackAction;
			t === "apply-all-damage" ? await ml(e) : t === "apply-damage" && await ml(e, Number(n.dataset.resultIndex));
		} catch (e) {
			n.removeAttribute("disabled"), ui.notifications.error(e instanceof Error ? e.message : String(e));
		} finally {
			dl.delete(e.id);
		}
	}
...
async function ml(e, t) {
	...
	let n = vl(e), r = n.results.find((e) => e.index === t);
	if (!r) throw Error(`Multiple-attack result ${t} is unavailable.`);
	await gl(e, n, r), await _l(e, n);
}
async function hl(e) {
	let t = vl(e), n = t.results.filter((e) => e.canApplyDamage && !e.damageApplied).map((e) => e.index);
	for (let r of n) {
		let n = t.results.find((e) => e.index === r);
		!n || n.damageApplied || (await gl(e, t, n), await _l(e, t));
	}
}
async function gl(e, t, n) {
	if (!n.canApplyDamage || n.damageApplied || !n.opposedTestData) throw Error(`Damage for attack ${n.index} is not available to apply.`);
	let r = CONFIG.ChatMessage.dataModels.opposed;
	if (!r) throw Error("The WFRP4e opposed Test model is unavailable.");
	let i = game?.wfrp4e?.config?.DAMAGE_TYPE?.NORMAL;
	if (i === void 0) throw Error("The WFRP4e normal damage type is unavailable.");
	await ll({
		damageType: i,
		messageId: e.id,
		recreateOpposedTest: (e) => new r({ opposedTestData: foundry.utils.deepClone(e) }).opposedTest,
		result: n
	}), t.damageApplicationsAvailable = Math.max(0, t.damageApplicationsAvailable - 1);
}
async function _l(e, t) {
	await e.update({
		content: await lc(t),
		[`flags.${Z}.multiAttack`]: t
	});
}
function vl(e) {
	let t = yl(e);
	if (!t) throw Error("This multiple-attack summary is unavailable.");
	return foundry.utils.deepClone(t);
}
function yl(e) {
	let t = e?.flags?.[Z];
	if (!(!t || typeof t != "object" || !("multiAttack" in t))) return t.multiAttack;
}
//#endregion
//#region src/module/patches/runtime.ts
function bl(e, t) {
	if (!e) return !1;
	let n = e.version.split(".")[0];
	return t.some((t) => t.foundryMajorVersion === n && t.systemId === e.system.id && t.systemVersion === e.system.version);
}
function xl(e, t, n) {
	let r = e.modules.get(t);
	return r?.active === !0 && r.version === n;
}
function Sl(e, t, n) {
	if (Object.hasOwn(e, t)) throw Error(`${Z} | ${n} is already installed.`);
}
function Cl(e, t) {
	Object.defineProperty(e, t, {
		configurable: !1,
...
//#endregion
//#region src/module/patches/item-piles/sheet-class-scope.ts
var wl = `${Z}.compatibility.item-piles-sheet-class-scope`, Tl = "item-piles", El = "3.3.4", Dl = "wfrp4e-archives3.enterprise", Ol = "wfrp4e-archives3", kl = "enterprise", Al = [{
	foundryMajorVersion: "14",
	systemId: "wfrp4e",
	systemVersion: "9.6.3"
}];
function jl() {
	let e = game;
	if (!bl(e, Al) || !xl(e, Tl, El)) return !1;
	let t = CONFIG.Actor.sheetClasses, n = t[Dl];
	if (!n) throw Error(`${Z} | Archives III Enterprise sheet-class scope is unavailable.`);
	if (Sl(t, wl, "Item Piles sheet-class scope compatibility patch"), Object.hasOwn(t, Ol)) throw Error(`${Z} | Item Piles sheet-class compatibility scope already exists.`);
	return Object.defineProperty(t, Ol, {
		configurable: !1,
		enumerable: !1,
		value: Object.freeze({ [kl]: n }),
		writable: !1
	}), Cl(t, wl), console.info(`${Z} | Applied Item Piles sheet-class scope compatibility patch for Item Piles ${El}.`), !0;
}
//#endregion
//#region src/module/patches/warhammer-lib/active-effect-schema.ts
var Ml = `${Z}.compatibility.warhammer-active-effect-schema`, Nl = "warhammer-lib", Pl = "3.3.3", Fl = [{
	foundryMajorVersion: "14",
	systemId: "wfrp4e",
	systemVersion: "9.6.3"
}];
function Il() {
	let e = game;
	if (!bl(e, Fl) || !xl(e, Nl, Pl)) return !1;
	let t = CONFIG.ActiveEffect.dataModels.base;
	if (!t) throw Error(`${Z} | WFRP Active Effect data model is unavailable.`);
	if (Sl(t, Ml, "Warhammer Active Effect schema compatibility patch"), t.schema.fields.changes) throw Error(`${Z} | WFRP Active Effect data model already defines the changes field.`);
	if (t.schema.extendFields(foundry.data.ActiveEffectTypeDataModel.defineSchema()), !t.schema.fields.changes) throw Error(`${Z} | Foundry Active Effect fields did not define the required changes field.`);
	return Cl(t, Ml), console.info(`${Z} | Applied Warhammer Active Effect schema compatibility patch for Warhammer Library ${Pl}.`), !0;
}
//#endregion
//#region src/module/patches/wfrp/armour-migration.ts
var Ll = `${Z}.compatibility.wfrp-armour-migration`, Rl = [{
	foundryMajorVersion: "14",
	systemId: "wfrp4e",
	systemVersion: "9.6.3"
}];
function zl() {
	let e = game;
	if (!bl(e, Rl)) return !1;
	let t = CONFIG.Item.dataModels.armour;
	if (!t) throw Error(`${Z} | WFRP armour data model is unavailable.`);
	let n = t.migrateData;
	Sl(n, Ll, "Armour migration compatibility patch");
	let r = function(e) {
		return n.call(this, e), e;
	};
	return Cl(r, Ll), t.migrateData = r, console.info(`${Z} | Applied armour migration compatibility patch for Foundry ${e.version} and WFRP ${e.system.version}.`), !0;
}
//#endregion
//#region src/module/patches/wfrp/roll-modes.ts
var Bl = `${Z}.compatibility.wfrp-roll-modes`, Vl = [{
	foundryMajorVersion: "14",
	systemId: "wfrp4e",
	systemVersion: "9.6.3"
}];
function Hl() {
	let e = game;
	if (!bl(e, Vl)) return !1;
	let t = e.wfrp4e?.config;
	if (!t) throw Error(`${Z} | WFRP runtime configuration is unavailable.`);
	return Sl(t, Bl, "WFRP roll-mode compatibility patch"), t.rollModes = CONFIG.ChatMessage.modes, Cl(t, Bl), console.info(`${Z} | Applied roll-mode compatibility patch for Foundry ${e.version} and WFRP ${e.system.version}.`), !0;
}
//#endregion
//#region src/module/song-magic/register-lore-of-song.ts
var Ul = "song", Wl = "Song", Gl = [
...
function Xl(e) {
	let t = e.source.tokenGeometry, n = Yl(e.source.size);
	return {
...
var Zl = "fvtt-wfrp-drowsy-content.unitTokenSync";
async function Ql(e) {
	let t = Q(e);
	if (!t) return;
	let n = Yl(t.size);
...
async function eu(e, t) {
	...
	await Promise.all(e.getActiveTokens().map((e) => ru(e.document, t))), await e.update(Object.fromEntries(Object.entries(t).map(([e, t]) => [`prototypeToken.${e}`, t])), { [Zl]: !0 });
}
function tu(e) {
	return !!e[Zl];
}
async function nu(e, t, n, r) {
	game?.user?.id !== r || tu(n) || !iu(t) || await Ql(e);
}
...
function au({ height: e, individuals: t, startX: n, startY: r, width: i }) {
	if (t < 1) return [];
...
function ou({ availableHeight: e, availableWidth: t, currentSize: n, imageHeight: r, imageWidth: i, source: a }) {
	let o = Yl(a.size), s = (a.tokenGeometry?.width ?? o.width) * Math.abs(a.tokenGeometry?.scaleX ?? o.scale), c = (a.tokenGeometry?.height ?? o.height) * Math.abs(a.tokenGeometry?.scaleY ?? o.scale), l = Yl(n), u = l.width * l.scale, d = l.height * l.scale, f = s / u * t * a.individualTokenScale, p = c / d * e * a.individualTokenScale, m = i / r;
	return m > f / p ? {
		height: f / m,
		width: f
	} : {
...
var $ = 512, cu = 26, lu = 22, uu = /* @__PURE__ */ new WeakMap(), du = /* @__PURE__ */ new WeakMap();
async function fu(e) {
	...
	try {
		...
		hu(e), e.mesh.texture = a, uu.set(e, {
			generation: i,
			key: n,
		...
		console.error(`Could not render Unit token mosaic from ${t.source.tokenImage}.`, n), du.get(e) === i && hu(e);
	}
}
async function pu(e) {
	await Promise.all(e.getActiveTokens().map(fu));
}
function mu(e) {
	du.set(e, (du.get(e) ?? 0) + 1), hu(e);
}
function hu(e) {
	let t = uu.get(e);
	t && (e.mesh.texture = t.originalMeshTexture, t.texture.destroy(!0), uu.delete(e));
}
async function gu(e) {
	let t = await Cu(e.source.tokenImage), n = document.createElement("canvas");
	n.width = $, n.height = $;
	let r = n.getContext("2d");
	if (!r) throw Error("The browser did not provide a 2D canvas context.");
	return yu(r), e.currentIndividuals > 0 ? _u(r, t, e) : xu(r), bu(r), Su(r, e.currentIndividuals), PIXI.Texture.from(n);
}
function _u(e, t, n) {
	let r = n.currentIndividuals, i = $ - lu * 2, a = $ - lu * 2 - cu, o = au({
		height: a,
		individuals: r,
		startX: lu,
		startY: 48,
		...
		source: n.source
	}), c = su(n.source.individualTokenRotation);
...
var wu = `${Z}.unitUpdate`, Tu = `${Z}.previousUnitConfiguration`, Eu = `${Z}.managedUnitUpdate`;
function Du(e) {
	if (!ic(e) || !e.parent) return;
	let t = e.parent;
	if (t.type !== "creature" && t.type !== "npc") return Lu("The Unit trait can only be added to Creature and NPC actors."), !1;
	if (ac(t)) return Lu(`${t.name} already has a Unit trait.`), !1;
	let n = $s(e.system.specification.value);
	if (!n) return Lu("A Unit must begin with a positive whole number of individuals."), !1;
	let r = t.system.details.size.value;
	if (!Qs(r)) return Lu(`Cannot create a Unit from unsupported source Size “${r}”.`), !1;
	let i = t.isToken && t.token ? t.token : t.prototypeToken, a = Number(t.system.details.move.value), o = Number(t.system.status.wounds.max), s = ql({
	...
	if (s.length > 0) return Lu(`Cannot form this Unit. ${s.join(" ")}`), !1;
	let c = {
		schemaVersion: 1,
		source: {
			attacks: 1,
...
async function Ou(e, t) {
	...
	}, { [wu]: !0 }), await Ql(e.parent), Ru(`${e.parent.name} formed a Unit of ${r} individuals.`);
}
function ku(e, t, n) {
	if (!ic(e)) return;
	if (Fu(t)) return Lu("A Unit cannot be disabled. Delete the trait to restore its source creature."), !1;
	let r = Pu(t);
	if (!(r === void 0 && !ju(t))) {
		if (r !== void 0 && !$s(r)) return Lu("A Unit must contain a positive whole number of starting individuals."), !1;
		n[Tu] = {
...
async function Au(e, t, n, r) {
	...
	await e.parent.update({
		...
		"system.status.wounds.value": Jl(l, e.parent.system.status.wounds.value, u)
	}, { [wu]: !0 }), await Ql(e.parent), i && await pu(e.parent);
}
function ju(e) {
...
var Hu = "prototypeToken.texture.src", Uu = "texture.src";
async function Wu(e, t, n) {
	let r = zu(t, Hu);
	game?.user?.id !== n || r === void 0 || await Ku(e, r);
}
async function Gu(e, t, n) {
	let r = zu(t, Uu);
	game?.user?.id !== n || !e.actor || r === void 0 || await Ku(e.actor, r);
}
async function Ku(e, t) {
	let n = ac(e), r = n ? rc(n) : void 0;
	if (!n || !r) return;
	let i = Bu(r, t);
	i && (await n.update({ [ec]: i }, { [Eu]: !0 }), await pu(e));
}
//#endregion
//#region src/module/unit/register-hooks.ts
function qu() {
	Hooks.on("preCreateItem", (...e) => Du(e[0])), Hooks.on("createItem", (...e) => Ou(e[0], e[3])), Hooks.on("preUpdateItem", (...e) => ku(e[0], e[1], e[2])), Hooks.on("updateItem", (...e) => Au(e[0], e[1], e[2], e[3])), Hooks.on("deleteItem", (...e) => Nu(e[0], e[2])), Hooks.on("updateActor", (...e) => nu(e[0], e[1], e[2], e[3])), Hooks.on("updateActor", (...e) => Wu(e[0], e[1], e[3])), Hooks.on("updateToken", (...e) => Gu(e[0], e[1], e[3])), Hooks.on("refreshToken", (...e) => fu(e[0])), Hooks.on("destroyToken", (...e) => mu(e[0]));
}
//#endregion
...
var Xu = cs("unit-manager", () => {
...
}), Zu = { class: "tw:text-2xl tw:font-semibold" }, Qu = {
	key: 0,
	class: "tw:dui-alert tw:dui-alert-error",
	role: "alert"
}, $u = {
	...
	class: "tw:dui-alert tw:dui-alert-error",
	role: "alert"
}, ed = { class: "tw:dui-stats tw:dui-stats-horizontal tw:w-full" }, td = { class: "tw:dui-stat" }, nd = { class: "tw:dui-stat-value" }, rd = { class: "tw:dui-stat-desc" }, id = { class: "tw:dui-stat" }, ad = { class: "tw:dui-stat-value" }, od = { class: "tw:dui-stat-desc" }, sd = { class: "tw:dui-stat" }, cd = { class: "tw:dui-stat-value" }, ld = { class: "tw:dui-stat-desc" }, ud = { class: "tw:text-lg tw:font-semibold" }, dd = { class: "tw:text-lg tw:font-semibold" }, fd = { class: "tw:text-lg tw:font-semibold" }, pd = ["value"], md = { class: "tw:dui-fieldset" }, hd = { class: "tw:dui-fieldset" }, gd = ["value"], _d = { class: "tw:dui-fieldset" }, vd = { class: "tw:dui-fieldset" }, yd = { class: "tw:dui-fieldset" }, bd = { class: "tw:dui-fieldset" }, xd = { class: "tw:dui-fieldset tw:md:col-span-2" }, Sd = { class: "tw:flex tw:items-center tw:gap-3" }, Cd = [
	"max",
	"min",
	"step"
], wd = { class: "tw:w-14 tw:text-right tw:font-semibold tw:tabular-nums" }, Td = ["disabled"], Ed = /* @__PURE__ */ Wn({
	...
	setup(e) {
		...
		return (t, s) => i.value ? (K(), Ui(gs, {
			...
			default: B(() => [
				J("header", null, [J("h1", Zu, k(e.actorName) + " Unit", 1), s[7] ||= J("p", { class: "tw:text-sm tw:opacity-75" }, " Current values respond to Wounds. Source values remain fixed until you save changes here. ", -1)]),
				i.value.destroyed ? (K(), q("div", Qu, [...s[8] ||= [J("span", null, "This Unit has no remaining individuals and is destroyed.", -1)]])) : Qi("", !0),
				L(n).error ? (K(), q("div", $u, [J("span", null, k(L(n).error), 1)])) : Qi("", !0),
				J("div", ed, [
					J("div", td, [
						s[9] ||= J("div", { class: "tw:dui-stat-title" }, "Individuals", -1),
						J("div", nd, k(i.value.currentIndividuals), 1),
						J("div", rd, "of " + k(i.value.source.startingIndividuals), 1)
					]),
					J("div", id, [
						s[10] ||= J("div", { class: "tw:dui-stat-title" }, "Ranks", -1),
						J("div", ad, k(i.value.ranks), 1),
						J("div", od, k(i.value.rankIncrement) + " individuals each", 1)
					]),
					J("div", sd, [
						s[11] ||= J("div", { class: "tw:dui-stat-title" }, "Attacks", -1),
						J("div", cd, k(i.value.attacks), 1),
						J("div", ld, " +" + k(i.value.rankBonusSL) + " SL after successful eligible Tests ", 1)
					])
				]),
				Y(hs, {
					size: "sm",
					...
					default: B(() => [
						Y(_s, {
							...
							default: B(() => [
								J("div", null, [s[12] ||= J("div", { class: "tw:text-xs tw:uppercase tw:opacity-60" }, "Wounds", -1), J("div", ud, k(i.value.currentWounds) + " / " + k(i.value.maximumWounds), 1)]),
								J("div", null, [s[13] ||= J("div", { class: "tw:text-xs tw:uppercase tw:opacity-60" }, "Unit Size", -1), J("div", dd, k(L(Gs)[i.value.size]), 1)]),
								J("div", null, [s[14] ||= J("div", { class: "tw:text-xs tw:uppercase tw:opacity-60" }, "Turning Cost", -1), J("div", fd, k(i.value.turningCost) + " Movement", 1)])
							]),
							_: 1
						}),
						J("progress", {
				...
				Y(hs, {
					...
					actions: B(() => [J("button", {
						class: "tw:dui-btn tw:dui-btn-primary tw:dui-btn-sm",
						disabled: L(n).saving
					}, k(L(n).saving ? "Saving…" : "Save Unit"), 9, Td)]),
					default: B(() => [Y(_s, {
						columns: "two",
						gap: "sm"
					}, {
						default: B(() => [
							J("fieldset", md, [s[16] ||= J("legend", { class: "tw:dui-fieldset-legend" }, "Starting individuals", -1), V(J("input", {
							...
							J("fieldset", hd, [s[17] ||= J("legend", { class: "tw:dui-fieldset-legend" }, "Source Size", -1), V(J("select", {
								"onUpdate:modelValue": s[1] ||= (e) => L(n).configuration.sourceSize = e,
								class: "tw:dui-select tw:dui-select-sm tw:w-full"
							}, [(K(!0), q(W, null, yr(L(r), ([e, t]) => (K(), q("option", {
								key: e,
								value: e
							}, k(t), 9, gd))), 128))], 512), [[vo, L(n).configuration.sourceSize]])]),
							J("fieldset", _d, [s[18] ||= J("legend", { class: "tw:dui-fieldset-legend" }, "Source Wounds", -1), V(J("input", {
							...
							J("fieldset", yd, [s[21] ||= J("legend", { class: "tw:dui-fieldset-legend" }, "Source Movement", -1), V(J("input", {
...
async function Dd(e, t) {
	...
	}, s = t.sourceWounds * t.startingIndividuals, c = Jl(a.maximumWounds, e.system.status.wounds.value, s);
	await r.update({
		[ec]: o,
...
async function Ad(e, t) {
	let n = Q(e);
	if (!n) return;
	let r = Ju(n.currentWounds, n.source.wounds, n.maximumWounds, t);
	r !== n.currentWounds && (await e.update({ "system.status.wounds.value": r }), await pu(e));
}
//#endregion
...
function jd() {
	...
	t.registerSheet(n, Z, kd(e.wfrp4e.apps.ActorSheetWFRP4eCreature, "DrowsyUnitCreatureSheet"), {
		label: "Unit Creature Sheet",
		makeDefault: !1,
		types: ["creature"]
	}), t.registerSheet(n, Z, kd(e.wfrp4e.apps.ActorSheetWFRP4eNPC, "DrowsyUnitNpcSheet"), {
